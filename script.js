...
(function () {
    ...
    const sentences = [
        ...
        'From neural foundations to Agentic AI we give you the skills, tools, and real-world projects to dominate the future.',
...
const CHAT_KB = [
    {
        keys: ['hello', 'hi', 'hey', 'namaste', 'hii', 'start', 'greeting'],
        reply: "Namaste! I'm <b>SHASTRA AI</b>, your 3D assistant. How can I help you today?",
        priority: 1
    },
    {
        keys: ['course', 'training', 'learn', 'teach', 'program', 'curriculum', 'algorithms', 'vibe coding', 'ai tools', 'non-tech'],
        reply: "We offer 4 flagship programs: <b>01_Algorithms</b> (Basics & Advanced), <b>02_Vibe Coding</b> (Advanced Prompting with Python), <b>03_AI Tools & Projects</b>, and <b>04_Non-Tech to Tech</b>.<br><br>📅 <b>Upcoming Schedule:</b><br>• <b>Algorithms</b> — Regular classes start <b>May 23rd</b> at <b>7:00 AM</b><br>• <b>Robot Creations</b> — Demo session on <b>May 24th</b>",
        priority: 10
    },
    {
        keys: ['enroll', 'join', 'register', 'apply', 'fee', 'price', 'cost', 'payment'],
        reply: "To enroll, visit <b>Connect.ai</b> on our site or email <a href='mailto:theaishastra@gmail.com'>theaishastra@gmail.com</a>. We'll onboard you within 24-48 hours!",
        priority: 10
    },
    {
        keys: ['business', 'enterprise', 'solution', 'automate', 'forge', 'process automation', 'karma mukti', 'vishesh yantra', 'marga darshana', 'tantra-vidya', 'udyam prajna', 'yantra srishti', 'robotics', 'drones'],
        reply: "Our <b>Forge Room</b> (Udyam Seva) provides:<br>• <b>Karma Mukti:</b> Process Automation<br>• <b>Vishesh Yantra:</b> Custom AI Tools<br>• <b>Marga Darshana:</b> AI Strategy & Consulting<br>• <b>Tantra-Vidya:</b> Deep Technology (ML/LLMs)<br>• <b>Udyam Prajna:</b> Business Intelligence<br>• <b>Yantra Srishti:</b> Robotics & Drones",
        priority: 10
    },
    {
        keys: ['internship', 'job', 'career', 'trainee', 'tribe', 'fellowship', 'work', 'experience', 'agentic ai', 'custom gpt'],
        reply: "Our <b>Tribe Fellowship</b> (Trainee Software Engineer Program) is a hands-on program where you work on live projects like <b>Agentic AI</b> and <b>Custom GPTs</b>. Top performers receive performance-based stipends!",
        priority: 10
    },
    {
        keys: ['who built', 'team', 'founder', 'hrushi', 'bhavaani', 'deekshitha', 'bhaskar', 'mohan', 'council'],
        reply: "Built by <b>The Council</b>: Hrushi (Architect), Bhavaani (Automation), Deekshitha (AIML), Bhaskar (ML/Analytics), and Mohan (Gen AI) — the minds behind The AI Shastra.",
        priority: 10
    },
    {
        keys: ['contact', 'phone', 'email', 'address', 'location', 'support', 'whatsapp', 'help', 'connect'],
        reply: "<b>Connect with us:</b><br>📧 theaishastra@gmail.com<br>📞 +91 63096 46644<br>📍 Hyderabad, India<br>⚡ Average response time: < 4 hours",
        priority: 10
    },
    {
        keys: ['thank', 'great', 'awesome', 'helpful', 'thanks', 'cool'],
        reply: "You're welcome! Knowledge is our supreme goal. Anything else I can help you with?",
        priority: 5
    },
    {
        keys: ['bye', 'goodbye', 'later', 'exit', 'quit'],
        reply: "Goodbye! See you soon in the AI world! Keep building.",
        priority: 5
    }
];
...
function loadVoices() {
    cachedVoices = speechSnyder.getVoices();
}
loadVoices();
if (speechSnyder.onvoiceschanged !== undefined) {
    speechSnyder.onvoiceschanged = loadVoices;
}
...
function getChatReply(input) {
    ...
    CHAT_KB.forEach(item => {
        ...
        item.keys.forEach(k => {
            if (q.includes(k)) {
                // Give higher score for exact keyword matches or longer keywords
                score += k.length;
                // Bonus for priority
    ...
    return (bestMatch && maxScore > 0) ? bestMatch.reply : "I'm still learning about that. Please ask about our <b>courses, business solutions, or internships</b>!";
}
...
function botRespond(html) {
    ...
    if (!isMuted) {
        ...
        const voices = cachedVoices.length ? cachedVoices : speechSnyder.getVoices();
        ...
        utter.onerror = () => document.getElementById('voiceWave').classList.remove('active');
